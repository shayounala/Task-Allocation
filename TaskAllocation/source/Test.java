...
public class Test {
	...
	public static void main(String[] args) {
		...
		{// test the output
			...
			try {
				Experiment.dataoutput = new DataOutputStream(
		...
		{// Test the Task
			...
			System.out.println("The Resource Value : "
					+ task.TotalNumber_Resource);
			System.out.println("The Resource Value : "
					+ task.Task_Resources.getValue());
		...
		{// Test the Agent
			...
			System.out.println("The Resource Value : "
					+ agent.TotalNumber_Resource);
			for (int i = 0; i < agent.Agent_Resources.Number_Resource.length; i++) {
				System.out.println("The Resource of the Type " + i + ": "
						+ agent.Agent_Resources.Number_Resource[i]);
			}
		}
	...
	private static void plotdots() {
		...
		for (int i = 0; i < 101; i++) {
			...
			double income = value * (Deadline - Deadline / Math.pow(extra, 2))
					/ Deadline * MaxExtra + value;
