...
public class DisplayUI {
	...
	public void open() {
		...
		cooperationcanvas = new Canvas(cooperationcomposite, SWT.DOUBLE_BUFFERED);
	...
	private void InitialShell(int type) {
		...
		this.getcomposites(type).setLayoutData(new GridData(SWT.FILL, SWT.FILL, true, true, 1, 1));
		

		System.out.println(this.getcanvass(type)==null);
		System.out.println(canvas==null);
		this.getcanvass(type).setLayoutData(new GridData(SWT.FILL, SWT.FILL, true, true, 1, 1));
